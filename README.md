...
Opens `http://127.0.0.1:8765/`. Default sources are bundled **TR-606 / TR-707 style loops** (synthesized 16-step grids in `web/tr.js`, not Roland ROMs). Also: pulse/sine song, microphone, tab capture, or a local file.
